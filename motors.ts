/**
 * Blocks for driving the rdtech Motor Driver Board
 */
//% weight=100 color=#00A654 icon="\uf21c" block="Motor Driver"
namespace rdtech_motor_driver {
	/************************************************************************************************************************************************
	...
	************************************************************************************************************************************************/
    ...
    export enum Motors {
        //%blockId=rdtech_motordriver_motor_one
        //% block="motor 1"
        Motor1,
        //%blockId=rdtech_motordriver_motor_two
        //% block="motor 2"
        Motor2
    }
     ...
     */
    //% blockId=rdtech_motordriver_motor_on
     ...
     */
    //% blockId=rdtech_motordriver_motor_off
